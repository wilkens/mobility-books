...
num_all_places : total combined *unique* places
gpe_sequences : order of GPEs in narrative with duplicates in sequence removed (i.e. India - India - Canada becomes India - Canada etc.)
dist_miles : total geodesic distance between gpe_sequences (see supplementary for calculation)
char_rank : rank of character's total mentions. Always 1 here because we condition on main character defined as most referenced character
...
B. Create semantic distance matrix
